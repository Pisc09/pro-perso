...
export default function MenuDialog({
  ...
  return (
    <Dialog
      className="lg:hidden"
      open={menuDialogVisible}
      onClose={() => setMenuDialogVisible(false)}
    >
        ...
        <div className="flex items-center justify-between">
          <div className="flex flex-1">
            <button
              ...
              onClick={() => setMenuDialogVisible(false)}
            >
          ...
          <a href="#" className="-m-1.5 p-1.5">
            <span className="text-2xl font-bold text-gray-900">3F</span>
          </a>
...
MenuDialog.propTypes = {
  menuDialogVisible: PropTypes.bool.isRequired,
  setMenuDialogVisible: PropTypes.func.isRequired,
};
